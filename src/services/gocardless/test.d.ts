...
export interface components {
  schemas: {
    ...
    ErrorCodes:
      ...
      | 'UNAUTHORIZED'
    /** @enum {string} */
    Categories: 'Food & Groceries' | 'Utilities' | 'Transfers'
  }
  responses: never
  parameters: never
  requestBodies: never
  ...
  getAccountTransactions: {
    parameters: {
      query?: {
        ...
        /** @description Both from and to have to be present to filter transactions by date */
        from?: string
        /** @description Both from and to have to be present to filter transactions by date */
        to?: string
      }
